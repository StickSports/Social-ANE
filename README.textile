...
This is an "Air native extension":http://www.adobe.com/devnet/air/native-extensions-for-air.html for send messages
to social networks on iOS. It utilizes the social functionality added in iOS6.
...
After launching the message view, the user may edit and send the message or may cancel it. When this process is complete,
one of two events will be dispatched form the Social object
